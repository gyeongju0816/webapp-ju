...
<body>
    ...
    <div class="layout">
        <div class="sidebar-container hidden">
            <nav>
                <ul>
                    <li><a href="#" onclick="loadPage('home', 'html_image/html/home.html')">홈</a></li>
                    
                    <c:if test="${not empty sessionScope.user }">
                    <li><a href="#" onclick="toggleSubmenu()">사용자 관리</a></li>
                    <ul id="submenu" class="submenu">
                        <li><a href="#" onclick="loadPage('userList', '/webapp-ju/user/userList')">사용자 목록</a></li>
